...
//const names = JSON.parse(Android.getAppNames());


//document.getElementById("appusage").innerHTML = names;
//const icons = Android.getAppIcons();
//const avgTimes = Android.getAvgTimes();

//Android.getNames();
function setName(name) {
    document.getElementById("szopas").innerHTML = name;
}
function setData(names, avgTimes) {
    //var ico = JSON.parse(Android.getIcon());
    //document.getElementById("szopas").innerHTML = "szopjFEL";
